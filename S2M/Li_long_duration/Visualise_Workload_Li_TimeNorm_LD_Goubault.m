%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%   Visualization — Variables Goubault vs RPE — G2 Long Duration   %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%  -----------------------------------------------------------------------
Mat_Vars   = NaN(length(G2_Liszt), N_bins, N_vars);
...
%  SAVE
%  -----------------------------------------------------------------------
save([PathSave '\Workload_Li_TimeNormalised_Goubault_G2.mat'], ...
    'Mat_Vars', 'Mat_RPE', 'valid_subj', 'Vars', 'N_bins', 'G2_Liszt');
fprintf('Sauvegarde : Workload_Li_TimeNormalised_Goubault_G2.mat\n');
...
sgtitle('Goubault 2023 — Top 10 variables Chord task — G2 n=23 — Temps normalisé (%)', ...
    'FontSize', 12, 'FontWeight', 'bold');

saveas(gcf, [PathSave '\Fig_TimeNorm_Goubault_G2.png']);
fprintf('Figure sauvegardee : Fig_TimeNorm_Goubault_G2.png\n');
